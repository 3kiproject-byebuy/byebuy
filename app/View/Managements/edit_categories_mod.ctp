	...
	<div class="list-group col-xs-4 col-xs-offset-1">
		...
		<table class="table">
    		...
    		<tr>
              ...
              <?php
              echo $this->Form->create('Mod',array('role' => 'form', 'class' => 'form-inline'));
              echo '<div class="form-group">';
              echo $this->Form->input('category_title',array('class' => 'form-control','label'=>false,'value'=>$category['Category']['category_title']));
              echo '</div>';
              ?>
